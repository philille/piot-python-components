...
TRIGGER_HUMIDIFIER_HUMIDITY_FLOOR_KEY   = 'triggerHumidifierHumidityFloor'
TRIGGER_HUMIDIFIER_HUMIDITY_CEILING_KEY = 'triggerHumidifierHumidityCeiling'

HANDLE_PRESSURE_CHANGE_ON_DEVICE_KEY = 'handlePressureChangeOnDevice'
TRIGGER_LED_PRESSURE_FLOOR_KEY   = 'triggerLEDPressureFloor'
TRIGGER_LED_PRESSURE_CEILING_KEY = 'triggerLEDPressureCeiling'
